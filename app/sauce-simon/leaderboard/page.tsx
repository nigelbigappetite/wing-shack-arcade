...
export default function SauceSimonLeaderboardPage() {
  ...
  const fetchLeaderboard = useCallback(async () => {
    ...
    try {
      ...
      console.log('🔍 Fetching leaderboard from /api/leaderboard?game_id=sauce-simon');
      const response = await fetch(`/api/leaderboard?game_id=sauce-simon&_t=${timestamp}`, {
        cache: 'no-store',
      });
      ...
      const mappedData = leaderboardData.map((entry: any) => ({
        id: entry.id,
        game_id: entry.game_id || 'sauce-simon',
